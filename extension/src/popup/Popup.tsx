      ...
      <div className="px-3 py-2 bg-slate-900/90 backdrop-blur-xl border-b border-slate-800/80 flex items-center gap-2 flex-shrink-0 sticky top-0 z-20">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-8 pr-7 py-1.5 rounded-lg bg-slate-950/80 border border-slate-700/80 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-pink-500 transition-all font-medium"
          />
          {searchQuery && (
            <button
        ...
        <button
          ...
          className="p-1.5 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-white transition-colors border border-slate-700 shrink-0"
